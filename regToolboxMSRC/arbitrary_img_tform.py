...
def arbitrary_transform(
    ...
    if src_type == "image":
        source = reg_image_preprocess(
            source_fp, src_reso, img_type="none", mask_fp=None, bounding_box=False
        )

    elif src_type == "ijroi" and ij_rois_fp is not None:
        try:
    ...
    # convert transforms to list for iteration
