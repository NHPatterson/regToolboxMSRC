...
def register_MSM(source_fp, source_res,
    ...
    tgt1_tgt2_tform_init, init_img = register_elx_(target1.image, target2.image, reg_param2, moving_mask = target1_mask_fp,  fixed_mask = target2_mask_fp, output_dir= pass_in + "_tforms_tgt1_tgt2_init", output_fn = pass_in + "tgt1_tgt2_init.txt", return_image = True, logging = True, bounding_box = False)
